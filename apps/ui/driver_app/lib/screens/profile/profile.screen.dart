...
import 'package:driver_app/core/widgets/profile-image.widget.dart';
import 'package:driver_app/core/widgets/section.widget.dart';
import 'package:driver_app/core/widgets/text-field.widget.dart';
            ...
            return SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    buildProfileImage(theme, state.userDetails.profileImgUrl),
                    ...
                    buildSectionCard(
                      ...
                      icon: Icons.person,
                      children: [
                        buildTextField(controller: _nameController, label: 'Full Name', icon: Icons.person_outline),
                        const SizedBox(height: 16),
                        buildTextField(controller: _phoneController, label: 'Phone Number', icon: Icons.phone_outlined, keyboardType: TextInputType.phone),
                        const SizedBox(height: 16),
                        buildTextField(controller: _addressController, label: 'Address', icon: Icons.home_outlined),
                      ],
                    ),
                    const SizedBox(height: 24),
                    buildSectionCard(
                      ...
                      children: [
                        buildTextField(controller: _makeController, label: 'Car Make', icon: Icons.branding_watermark_outlined),
                        const SizedBox(height: 16),
                        buildTextField(controller: _modelController, label: 'Car Model', icon: Icons.model_training_outlined),
                        const SizedBox(height: 16),
                        buildTextField(controller: _colorController, label: 'Color', icon: Icons.color_lens_outlined),
                        const SizedBox(height: 16),
                        buildTextField(controller: _licensePlateController, label: 'License Plate', icon: Icons.pin_outlined),
                        const SizedBox(height: 16),
                        buildTextField(controller: _capacityController, label: 'Capacity', icon: Icons.people_outline, keyboardType: TextInputType.number),
                      ],
                    ),
